...
import { useCreateBookCategoryMutation } from "@/store/bookCategories/bookCategoriesApi";
...
export default function CreateLibraryCategory() {
  ...
  const t = translate?.pages.bookCategories.createCategory;
