...
import { useGetBookCategoryByIdQuery } from "@/store/bookCategories/bookCategoriesApi";
...
export default function ViewLibraryCategory() {
  ...
  const t = translate?.pages.bookCategories.viewCategory;
  const pg = translate?.pages.bookCategories;
  const categoryId = Number(id);

  const { data: category, isLoading, isError } = useGetBookCategoryByIdQuery(
    categoryId,
    {
