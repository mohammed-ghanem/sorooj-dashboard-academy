...
} from "@/store/scientificTrackSubjectExams/scientificTrackSubjectExamsApi";
import { useSessionReady } from "@/hooks/useSessionReady";

import type { ISubjectExamSavePayload } from "@/types/subjectExam";
import type { ILessonExamQuestion } from "@/types/lessonExam";

/** Same pattern as `components/subjects/exam/SubjectExamForm` */
export default function ScientificTrackSubjectExamForm() {
  ...
  const ex = translate?.pages.scientificTrackSubjects.subjectExam as Record<
    string,
    string | undefined
  >;
  ...
  return (
    <SharedExamForm
      ...
      afterSavePath={`${langPrefix}/singleLearnPath/subjects/exam/${subjectId}`}
      backListPath={`${langPrefix}/singleLearnPath/subjects`}
      onCreate={(payload) =>
        createExam({
          subjectId,
