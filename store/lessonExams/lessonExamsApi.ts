...
function normalizeQuestion(item: any): ILessonExamQuestion {
...
export function normalizeLessonExam(row: any): ILessonExam {
  ...
  return {
    ...
    lesson_id: r?.lesson_id != null ? Number(r.lesson_id) : undefined,
...
function appendQuestions(fd: FormData, questions: ILessonExamQuestion[]) {
...
function buildExamFormData(payload: ILessonExamSavePayload) {
...
function buildUpdateExamFormData(payload: ILessonExamSavePayload) {
